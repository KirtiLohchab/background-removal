...
const Testimonials = () => {
  return (
    <div>
      {/* title */}
      <h1 className=" text-center text-2xl md:text-3xl lg:text-4xl mt-4 font-bold py-5 bg-gradient-to-r from-gray-900 to-gray-400 bg-clip-text text-transparent">
